  ...
  return (
    <div className={`${styles.boxWidth}`}>
      {!showResult ? (
        ...
        <div className="px-3 bg-slate-700 p-4 h-[600px] overflow-y-scroll  w-full">
          <h2 className="text-lg italic leading-[1.8] font-bold mb-4">{recentPrompt}</h2>
          {loading ? (
            ...
            <p
              ...
              className={`${styles.paragraph} font-[400] leading-[1.8]`}></p>
          )}
        </div>
      )}
      {/* 
